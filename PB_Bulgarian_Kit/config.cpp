...
///VESTS///
	class PB_M18_iotv_base: Vest_Camo_Base
	{
		author = "Kartsa";
		scope = 0;
		...
		hiddenSelectionsTextures[] = 
		{
			"PB_Bulgarian_Kit\data\M18_iotv_01_co.paa",
			"PB_Bulgarian_Kit\data\M18_iotv1_co.paa",
			"PB_Bulgarian_Kit\data\M18_iotv2_co.paa",
			"PB_Bulgarian_Kit\data\M18_iotv3_co.paa"
		};
	...
	class PB_M18_iotv: PB_M18_iotv_base
	{
		picture = "\PB_Main\ui\vest_test.paa";
		scope = 2;
		displayName = "[M18] Vest";
	...
	class PB_M18_iotv_Grenadier: PB_M18_iotv_base
	{
		picture = "\PB_Main\ui\vest_test.paa";
		scope = 2;
		displayName = "[M18] Vest (Grenadier)";
	...
	class PB_M18_iotv_Medic: PB_M18_iotv_base
	{
		picture = "\PB_Main\ui\vest_test.paa";
		scope = 2;
		displayName = "[M18] Vest (Medic)";
	...
	class PB_M18_iotv_Rifleman: PB_M18_iotv_base
	{
		picture = "\PB_Main\ui\vest_test.paa";
		scope = 2;
		displayName = "[M18] Vest (Rifleman)";
	...
	class PB_M18_iotv_ocp_Teamleader: PB_M18_iotv_base
	{
		picture = "\PB_Main\ui\vest_test.paa";
		scope = 2;
		displayName = "[M18] Vest (Teamleader)";
