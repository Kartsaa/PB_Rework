...
class PB_Kitbag_M98;
class PB_Medbag_M98;
class PB_CARRYALL_M98;
class PB_Radiobag_M98;
///BAGS///
class PB_NOR_RIF_BP: PB_Kitbag_M98
{
	scope = 1;
...
class PB_NOR_RADIO_BAG: PB_Radiobag_M98
{
	scope = 1;
	class TransportItems
	{
...
class PB_NOR_MED_BAG: PB_Medbag_M98
{
    scope = 1;
	class TransportItems
	{
...
class PB_NOR_MG_BAG: PB_Kitbag_M98
{
	scope = 1;
	class TransportItems
	{
...
class PB_NOR_AT_BAG: PB_CARRYALL_M98
{
	scope = 1;
	class TransportItems
	{
...
class PB_NOR_ENG_BP: PB_Kitbag_M98
{
	scope = 1;
	class TransportItems
	{
...
class PB_NOR_EOD_BP: PB_Kitbag_M98
{
	scope = 1;
	class TransportItems
	{
...
class PB_NOR_GRE_BP: PB_Kitbag_M98
{
	scope = 1;
	class TransportItems
	{
