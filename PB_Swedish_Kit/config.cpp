...
///UNIS///
	...
	class PB_M90_U_B: B_Soldier_base_F
	{
		scope = 1;
		author = "Kartsa";
		...
		hiddenSelections[] = {"camo","insignia"};
		hiddenSelectionsTextures[] = {"\PB_Swedish_Kit\data\M90_U_01_CO.paa"};
	};
	class PB_M90_U_B_R: B_Soldier_base_F
	{
		scope = 1;
		author = "Kartsa";
...
///HELMETS
	...
	class PB_M90_FAST_C: Helmet_Base
	{
		author = "Kartsa";
		scope = 2;
		weaponPoolAvailable = 1;
		...
		hiddenSelectionsTextures[] = 
		{
			...
			"",
			"",
			"\PB_Swedish_Kit\data\M90_cover_co.paa",
			""
		};
		class ItemInfo: HeadgearItem
		{
	...
	class PB_M90_FAST_C_H: Helmet_Base
	{
		author = "Kartsa";
		scope = 2;
		weaponPoolAvailable = 1;
