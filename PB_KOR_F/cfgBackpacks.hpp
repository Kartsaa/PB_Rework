///INHERITANCE///
class PB_EAGLE_GRANITEB;
class PB_CARRYALL_GRANITEB;
class PB_Radiobag_GRANITEB;
class PB_EAGLE_MED_GRANITEB;
///BAGS///
class PB_KOR_RIF_BP: PB_EAGLE_GRANITEB
{
	scope = 1;
...
class PB_KOR_AT_BP: PB_EAGLE_GRANITEB
{
	scope = 1;
	class TransportItems
	{
...
class PB_KOR_RADIO_BAG: PB_Radiobag_GRANITEB
{
	scope = 1;
	class TransportItems
	{
...
class PB_KOR_MED_BAG: PB_EAGLE_MED_GRANITEB
{
    scope = 1;
	class TransportItems
	{
...
class PB_KOR_MG_BAG: PB_CARRYALL_GRANITEB
{
	scope = 1;
	class TransportItems
	{
...
class PB_KOR_ENG_BP: PB_EAGLE_GRANITEB
{
	scope = 1;
	class TransportItems
	{
...
class PB_KOR_EOD_BP: PB_EAGLE_GRANITEB
{
	scope = 1;
	class TransportItems
	{
...
class PB_KOR_GRE_BP: PB_EAGLE_GRANITEB
{
	scope = 1;
	class TransportItems
	{
